...
export default function Coming_soon() {
    const { t } = useTranslation("series-znag");

    return (
        <>
            <Head>
                <title>GEorGE • Cosmetic • ZnAg</title>
                ...
                <div className={styles.aurumContainer}>
                    <div className={styles.aurumText}>
                        <Image
                            ...
                            height={1000}
                            alt=""
                            src={"/static/znag/srebyrna-seria.jpg"}
                        />
                        ...
                        <p className={styles.textCard}>
                            <Trans i18nKey={t("paragraph14") || " "} />
                        </p>
                        <p className={styles.textCard}>
                            <Trans i18nKey={t("paragraph15") || " "} />
                        </p>
                    </div>
                </div>
            </div>
